...
Else 
	...
	$extract:=cs:C1710.extract.new("html")
	
	var $srcFolder : 4D:C1709.Folder
	$srcFolder:=Folder:C1567(fk documents folder:K87:21).folder("samples/html")
	
	ASSERT:C1129($srcFolder.exists)
	
	var $dstFolder : 4D:C1709.Folder
	$dstFolder:=Folder:C1567(fk desktop folder:K87:19).folder("extract/html")
	$dstFolder.create()
